...
resultsFileSdfa = strcat(resultsDir,'portSDFALogLoss.csv');
resultsFileSpsa = strcat(resultsDir,'portSPSALogLoss.csv');
...
orderLabels = {'F1','F2','F3','V1','V2','V3','V4','V5','V6','V7','V8','V9','V10'};
