function portFixed(maxSpreads, distances, thresholds, orders, results, column, metric, titlePrefix)
    ...
    for spread=maxSpreads
        ...
        for threshold=thresholds
            ...
            title(figureTitle);
            set(gcf,'Color','w');
            pdfTitle = strcat(titlePrefix,'PortFixed',metric{1,1},'Spread',num2str(spread),'Threshold',num2str((100*threshold)),'.pdf')
            export_fig(pdfTitle);
        end
    end
