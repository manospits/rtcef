...
object CSTLearner {
  /**
    ...
    * @param iso The isomorphism of the SDFA for which we want to learn a PST.
  ...
  def apply(
           ...
           ): CSTLearner = new CSTLearner(maxOrder, iso, partitionAttribute)
}
