...
import fsm.symbolic.sfa.logic.{AtomicSentence, Predicate, PredicateConstructor, Sentence}
...
import workflow.provider.source.sdfa.{SDFASource, SDFASourceDFA, SDFASourceDirect, SDFASourceDirectI, SDFASourceFormula, SDFASourceFromSRE, SDFASourceLLDFA, SDFASourceSerialized}
